    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <a href="${process.env.LIVE_WEBSITE_LINK + "/profile/" + fromUsername
        ...
        <div class="footer">
          ...
          You are receiving this email because you're a registered user at <a href="${process.env.LIVE_WEBSITE_LINK
                }">DevRoot</a>.
        </div>
      </div>
    </body>
